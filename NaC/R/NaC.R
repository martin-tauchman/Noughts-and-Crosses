...
NaC <- function(field) {
  ...
  if(!(is.numeric(field))) {stop("Argument â€˜fieldâ€™ has to be a number. If you want to know more, type â€˜rules()â€™ and press enter.")}
  if(!(field %in% 1:9)) {stop("Argument â€˜fieldâ€™ has to be a nummer from 1 to 9. If you want to know more, type â€˜rules()â€™ and press enter.")}
